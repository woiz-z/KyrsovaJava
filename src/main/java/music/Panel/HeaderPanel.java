 ...
 * інформації про музичну збірку, таку як назва, кількість треків, загальна тривалість
...
public class HeaderPanel {
     ...
     *
     * @param compilation Музична збірка, інформація про яку відображається.
    ...
    /**
     * Створює мітку заголовка з ефектом тіні для назви збірки.
     *
     * @param compilation Музична збірка для відображення назви.
    ...
    /**
     * Створює інформаційну мітку з даними про збірку.
     *
     * @param compilation Музична збірка для відображення інформації.
     ...
     *
     * @param trackCount    Кількість треків у збірці.
